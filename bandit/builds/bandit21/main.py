...
def get_network_traffic():
    ...
    Does not require sudo privileges by the user.
    ...
    os.setuid(0)
    pcap = Popen(["timeout", "2", "tcpdump", "-w", "capture.pcap", "-i", "any", "-n"], stdin=PIPE, stdout=PIPE, stderr=PIPE, text=True)
    res = pcap.communicate()
